...
public class ArraySortTest {
	...
	public void testQuickSortRandom() {
		...
		ArrayList<Integer> ar1 = ArraySort.quickSort(arr);
		// step 2: check the length of the array
		assertEquals(5,ar1.size());

		// step 2: check if the array is sorted
		assertTrue(ArraySort.isSorted(ar1));
	}
	...
	public void testQuickSortEmpty() {
		...
		ArrayList<Integer> sr = ArraySort.quickSort(arr);
		// step 2: check the length of the array
		assertEquals(0,sr.size());

		// step 2: check if the array is sorted
		assertTrue(ArraySort.isSorted(sr));
	}
}
